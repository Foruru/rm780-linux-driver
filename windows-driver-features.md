...
1. [Driver Features](#driver-features)
   1. [Profiles](#profiles)
   2. [Bindings](#bindings)
       1. [Available Buttons](#available-buttons)
       2. [Assignable Functions](#assignable-functions)
       3. [Dropdown Values](#dropdown-values)
   3. [DPI Settings](#dpi-settings)
   4. [Lighting](#lighting)
   5. [Mouse Parameters](#mouse-parameters)
   6. [Macro Editor](#macro-editor)
      1. [Macro List](#macro-list)
      2. [Key List](#key-list)
      3. [Recording Options](#recording-options)
      4. [Manual Event Insertion](#manual-event-insertion)
